      ...
      <div class="profile-widget">
        ...
        <div class="pro-content">
          ...
          <ul class="available-info">
            ...
            <li>
              <i class="far fa-money-bill-alt"></i> $300 - $1000 <i class="fas fa-info-circle" data-toggle="tooltip"
                title="Lorem Ipsum"></i>
            </li>
          </ul>
      ...
      <div class="profile-widget">
        ...
        <div class="pro-content">
          ...
          <ul class="available-info">
            ...
            <li>
              <i class="far fa-money-bill-alt"></i> $50 - $300 <i class="fas fa-info-circle" data-toggle="tooltip"
                title="Lorem Ipsum"></i>
            </li>
          </ul>
          <div class="row row-sm">
      ...
      <div class="profile-widget">
        ...
        <div class="pro-content">
          ...
          <ul class="available-info">
            ...
            <li>
              <i class="far fa-money-bill-alt"></i> $100 - $400 <i class="fas fa-info-circle" data-toggle="tooltip"
                title="Lorem Ipsum"></i>
            </li>
          </ul>
          <div class="row row-sm">
      ...
      <div class="profile-widget">
        ...
        <div class="pro-content">
          ...
          <ul class="available-info">
            ...
            <li>
              <i class="far fa-money-bill-alt"></i> $150 - $250 <i class="fas fa-info-circle" data-toggle="tooltip"
                title="Lorem Ipsum"></i>
            </li>
          </ul>
          <div class="row row-sm">
